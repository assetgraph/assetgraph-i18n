        ...
        Loader.prototype = {
          ...
          newModule: function (obj) {
            ...
            if (Object.getOwnPropertyNames && obj != null) {
              ...
              pNames = [];
              for (var key in obj) pNames.push(key);
            }
        ...
        function getCJSDeps(source) {
          ...
          while ((match = cjsRequireRegEx.exec(source))) {
            ...
            for (var i = 0; i < commentLocations.length; i++) {
              if (
                commentLocations[i][0] < match.index &&
                commentLocations[i][1] > match.index + match[0].length
              )
                inComment = true;
            }
            if (!inComment) deps.push(match[1].substr(1, match[1].length - 2));
          }
