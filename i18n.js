...
module.exports = {
    // These are maintained here because we haven't been able to work out how
    // to use relative requires in a system.js plugin:
    tokenizePattern: tokenizePattern,
    eachI18nTagInHtmlDocument: eachI18nTagInHtmlDocument,
    createI18nTagReplacer: createI18nTagReplacer,
