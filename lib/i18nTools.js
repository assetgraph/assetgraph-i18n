const _ = require('lodash'), memoizeSync = require('memoizesync'), esmangle = require('esmangle'), esanimate = require('esanimate'), escodegen = require('escodegen'), estraverse = require('estraverse'), i18nTools = {};
...
i18nTools.extractAllKeysForLocale = function(assetGraph, localeId) {
  ...
  const allKeys = i18nTools.extractAllKeys(assetGraph), prioritizedLocaleIds = i18nTools.expandLocaleIdToPrioritizedList(localeId), allKeysForLocale = {};
...
i18nTools.createTrReplacer = function(options) {
  ...
  return function trReplacer(options) {
    ...
    if (type === 'callTR.PAT') {
      ...
      const argumentNameAsts = [], placeHolderAsts = [];
