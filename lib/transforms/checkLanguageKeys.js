          ...
          function checkThatValuesAreStructurallySimilar(
            ...
            if (
              ...
              if (
                ...
                var keysPresentInOneOrMoreValues = _.union.apply(
                  _,
    ...
    if (defaultLocaleId) {
      ...
      Object.keys(defaultValueInfosByKey).forEach(function(key) {
        ...
        if (allValuesAreIdentical) {
          var stringifiedDefaultLocaleValue = JSON.stringify(
          ...
          defaultValueInfos.forEach(function(defaultValueInfo) {
            var stringifiedValue = util.inspect(
      ...
      .forEach(function(htmlAsset) {
        ...
        Array.prototype.slice
          ...
          .forEach(function(element) {
            ...
            var hasNonWhitespaceChildNodes = Array.prototype.slice
            ...
            var i18nAttributes = _.toArray(element.attributes).filter(function(
              attribute
            ) {
            ...
            if (hasNonWhitespaceChildNodes || i18nAttributes.length > 0) {
              var matchingOccurrences = occurrences.filter(function(
                occurrence
              ) {
